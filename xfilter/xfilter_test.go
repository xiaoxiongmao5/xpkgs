...
func TestFilterList(t *testing.T) {
	...
	users = append(users, &User{Name: "21赵六", CreatedTm: "2021-01-04"})
	...
	expectList := []string{"21赵六", "a张三", "b王五", "c孙七", "李四", "吴九", "郑十", "周八"}
	...
	expectList = []string{"郑十", "吴九", "周八", "c孙七", "21赵六", "b王五", "李四", "a张三"}
	Check(t, list, expectList)
	...
	expectList = []string{"周八", "郑十", "吴九", "李四", "c孙七", "b王五", "a张三", "21赵六"}
	Check(t, list, expectList)
}
